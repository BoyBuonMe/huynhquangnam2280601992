    ...
    try:
        ...
        while True:
            ...
            for client in clients:
                if client != client_socket:  # Không gửi lại cho client gửi tin
                    try:
                        client.send(data)
                    except:
                        clients.remove(client)  # Loại bỏ client nếu có lỗi khi gửi
    except:
